      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.card}>
          <View style={styles.row}>
            <View style={[styles.iconChip, { backgroundColor: colors.recognitionBg }]}>
        ...
        <TouchableOpacity style={styles.card} activeOpacity={0.7} onPress={() => navigation.navigate('GstinSetup', { mode: 'edit' })}>
          <View style={styles.row}>
            <View style={[styles.iconChip, { backgroundColor: '#EEF6EE' }]}>
        ...
        <TouchableOpacity style={styles.card} activeOpacity={0.7} onPress={() => navigation.navigate('WhatsAppDemo')}>
          <View style={styles.row}>
            <View style={[styles.iconChip, { backgroundColor: '#E7F8EF' }]}>
        ...
        <TouchableOpacity style={styles.card} activeOpacity={0.7} onPress={() => navigation.navigate('History')}>
          <View style={styles.row}>
            <View style={[styles.iconChip, { backgroundColor: '#FFF3E8' }]}>
        ...
        <TouchableOpacity style={styles.clearButton} onPress={handleClearData} activeOpacity={0.8}>
          <Trash2 size={18} color={colors.severity.blocked} />
...
const styles = StyleSheet.create({
  ...
  shopName: { fontSize: 20, fontWeight: '800', color: colors.surface },
  gstinSmall: { ...typography.caption, color: 'rgba(255,255,255,0.8)', marginTop: 4 },
  ...
  iconChip: { width: 44, height: 44, borderRadius: 14, justifyContent: 'center', alignItems: 'center' },
  ...
  langToggle: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm },
  langOption: { ...typography.label, color: colors.inkMuted },
  langOptionActive: { color: colors.primary, fontWeight: '700' },
  cardValue: { ...typography.body, color: colors.ink },
  ...
  clearButtonText: { ...typography.label, color: colors.severity.blocked, fontWeight: '600' },
  ...
  aboutBody: { ...typography.body, color: colors.inkSecondary, marginTop: spacing.md, marginBottom: spacing.md, fontSize: 14 },
  pointRow: { flexDirection: 'row', gap: spacing.sm, marginBottom: spacing.sm },
